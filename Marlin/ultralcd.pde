...
//ELEFU: We changed the LCD from the defauly library to be TWI compatible. Huzzah. Some minor changed below relate to this as well.
...
LiquidCrystal_I2C lcd(0x27,LCD_WIDTH,LCD_HEIGHT);  //ELEFU: LCD TWI init statement replaced old one 
...
//ELEFU: TIM, PUT AN UPDATE FOR LCD MESSAGES IN HERE ON THE TLC
...
void lcd_init()
{
  ...
  lcd.init();//ELEFU: initialize the lcd over TWI
  lcd.backlight();//ELEFU: turn on backlight.
...
//ELEFU: TIM, THE MAIN LCD SCREEN STUFF HAPPENS HERE:
