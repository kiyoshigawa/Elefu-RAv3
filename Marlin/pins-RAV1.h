...
#define HEATER_2_PIN       -1	//not used on RA v1
#define TEMP_0_PIN         2	// ANALOG NUMBERING
#define TEMP_1_PIN         1 //1	// ANALOG NUMBERING
#define TEMP_2_PIN         0 //0	// ANALOG NUMBERING
